...
* [Task 5.3: Create an IAM Policy and Role to run the application](#Task53)
* [Task 5.4: Test the web app locally](#Task54)
* [Task 5.5: Create the AWS Beanstalk environment and deploy a sample web app](#Task55)
* [Task 5.6: Configure Elastic Beanstalk CLI and deploy the target web app](#Task56)
...
## Task 5.3: Create an IAM Policy and Role to run the application
...
## Task 5.4: Test the web app locally
